...
complete -c envx -n "__fish_envx_using_subcommand fmt" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c envx -n "__fish_envx_using_subcommand help; and not __fish_seen_subcommand_from run export eval print completions fmt help" -f -a "run" -d 'Evaluate a .envx file and run a command with those variables injected'
complete -c envx -n "__fish_envx_using_subcommand help; and not __fish_seen_subcommand_from run export eval print completions fmt help" -f -a "export" -d 'Print all variables as `export KEY="VALUE"` statements'
complete -c envx -n "__fish_envx_using_subcommand help; and not __fish_seen_subcommand_from run export eval print completions fmt help" -f -a "eval" -d 'Evaluate a single expression using OS environment for variable references'
complete -c envx -n "__fish_envx_using_subcommand help; and not __fish_seen_subcommand_from run export eval print completions fmt help" -f -a "print" -d 'Print all resolved variables as KEY=VALUE pairs'
complete -c envx -n "__fish_envx_using_subcommand help; and not __fish_seen_subcommand_from run export eval print completions fmt help" -f -a "completions" -d 'Print the shell completion script for the given shell'
complete -c envx -n "__fish_envx_using_subcommand help; and not __fish_seen_subcommand_from run export eval print completions fmt help" -f -a "fmt" -d 'Format a .envx file — aligns `=` across all assignments'
complete -c envx -n "__fish_envx_using_subcommand help; and not __fish_seen_subcommand_from run export eval print completions fmt help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
